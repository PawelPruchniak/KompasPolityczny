...
class TestViewModel : ViewModel() {
    ...
    private fun resetQuestionList() {
        questionList = mutableListOf(
            ...
            Question("Od każdego według jedgo zdolności, każdemu według jego potrzeb, jest dobrą myślą.", "Gospodarka", false),
            ...
            Question("Transfery socjalne powinni zostać znacznie ograniczone.", "Gospodarka", true),
            Question("Własność prywatna jest podstawą gospodarki.", "Gospodarka", true),
            Question("Państwo powinno zapewniać pracę i zamieszkanie dla najbiedniejszych.", "Gospodarka", false),
            ...
            Question("W celu ochorny naszego kraju, czasem nieunikniona jest interwencja zbrojna.", "PolitykaZ", false),
            ...
            Question("Państwo powinno tworzyćć program nauczania według którego powinny trzymać się wszystkie szkoły.", "PolitykaW", false),
